...
namespace Assignment6
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //1.
            var DOJBefore2015 = empList.Where(e => e.DOJ < new DateTime(2015, 1, 1));
            Console.WriteLine("****Employees DOJ before 2015 : ****");
            foreach (var employee in DOJBefore2015)
            {
            ...
            //3.
            var conAndass = empList.Where(e => e.Title == "Consultant" || e.Title == "Associate");
            Console.WriteLine("Employees with Job title as Consultants or Associates: ");
            foreach (var employee in conAndass)
            {
            ...
            //5.
            int EmplysInChennai = empList.Count(e => e.City == "Chennai");
            Console.WriteLine($"Total Employee Count in Chennai: {EmplysInChennai}");
            ...
            //7.
            int EmplysAfter2015 = empList.Count(e => e.DOJ > new DateTime(2015, 1, 1));
            Console.WriteLine($"Total Employees joined after 2015: {EmplysAfter2015}");

            //8.
            int NotAssociates = empList.Count(e => e.Title != "Associate");
            Console.WriteLine($"Total number of Employees who are not Associates: {NotAssociates}");
            ...
            Console.WriteLine($"Youngest Employee: ID: {youngestEmp.EmployeeId}, Name:{youngestEmp.FirstName} {youngestEmp.LastName}, Title: {youngestEmp.Title}, DOB: {youngestEmp.DOB.ToShortDateString()}, City: {youngestEmp.City}");
